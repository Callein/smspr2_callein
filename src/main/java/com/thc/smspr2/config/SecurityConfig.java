...
public class SecurityConfig {
    ...
    private final CorsFilterConfig corsFilterConfiguration;
    private final ObjectMapper objectMapper;
    private final AuthService authService; // 토큰 팩토리라고 생각해주세요!
    private final ExternalProperties externalProperties;

    public SecurityConfig(TbuserRepository tbuserRepository, CorsFilterConfig corsFilterConfiguration, ObjectMapper objectMapper, AuthService authService
